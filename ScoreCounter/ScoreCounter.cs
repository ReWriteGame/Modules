...
namespace Modules.Score
{
    ...
    public class ScoreCounter
    {
        ...
        public bool CheckValueIsMin => data.CheckValueIsMin;
        public bool CheckValueIsMax => data.CheckValueIsMax;

        #endregion

        #region Сonstructors

        public ScoreCounter() => data = new ScoreCounterData();
        public ScoreCounter(ScoreCounterData data) => this.data = data;
        ...
        public float GetValueInPercent() => GetValueInPercent(data.Value, data.MinValue, data.MaxValue);
        ...
        private float GetValueInPercent(float value, float minValue, float maxValue) =>
